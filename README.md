...
- Compatible with dozens of dictionaries formats
- Brings its own dictionaries (in an open format, reusable everywhere)
- Simple and nice interface
- Cross-platform
- Off-line

Remède is for **everyone**.

## Community

The Remède community is very small at the moment. You can make part of the Remède community now :
- Join us on Matrix : [#remede:matrix.org](https://matrix.to/#/#remede:matrix.org)
...
Remède is brought to you with love by the contributors. Thanks to
